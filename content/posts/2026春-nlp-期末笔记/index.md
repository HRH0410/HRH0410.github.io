+++
title = "2026春 NLP 期末笔记"
date = "2026-07-02T08:05:16+08:00"
draft = false
postType = "study"
tags = ["数字花园", "Notion"]
categories = ["学习笔记"]
showTableOfContents = true
notionSource = "2026春 NLP 期末笔记 387f867979aa80d8ad34ee12ea0e67ca.md"
+++
...
\[
\lt BOS\gt \ w_1w_2\cdots w_m\ \lt EOS\gt 
\]
...
[2025秋 深度学习 期末笔记：ReLU](../2025秋-深度学习-期末笔记/#relu)
...
[2025秋 深度学习 期末笔记：循环神经网络](../2025秋-深度学习-期末笔记/#rnn-section)
...
更详细的推导见：[2025秋 深度学习 期末笔记：循环神经网络](../2025秋-深度学习-期末笔记/#rnn-section)
...
如果 \(|\gamma|\lt 1\)，随着 t-k 变大，\(\gamma^{t-k}\) 会迅速趋近于 0，这就是梯度消失。模型就很难把后面损失的信息传回很早的位置，也就学不到长距离依赖。
...
<figure class="article-raw-image">
  <img src="assets/image-74.png" alt="NER 序列标注示意图" loading="lazy">
</figure>
...
<figure class="article-raw-image">
  <img src="assets/image-75.png" alt="NER 评价指标示意图" loading="lazy">
</figure>

<figure class="article-raw-image">
  <img src="assets/image-76.png" alt="NER 示例图" loading="lazy">
</figure>
...
Transformer详解见：[Transformer 学习笔记](../transformer-notes/)
...
\[
BP=\begin{cases}1, & c\gt r\\e^{1-r/c}, & c\le r\end{cases}
\]
