...
<a class="ink-action" href="https://github.com/HRH0410" target="_blank" rel="noopener noreferrer">GitHub</a>
</div>
</section>
...
<span class="status">冷启动 · 内测中</span>
</div>
<div class="tags">
<span>科研机会</span>
<span>学术连接</span>
...
<p class="project-desc">Labora 是一座面向高校科研的“学术广场”，也是一个科研机会发现与连接平台。我们希望让散落在群聊、朋友圈和熟人推荐里的招募信息可以被沉淀、搜索和筛选，让想参与科研的学生与正在寻找伙伴的老师、团队更容易找到彼此。</p>
</div>
</div>
...
<span class="status status--stars" id="wiki-stars" style="display:none;">
...
<script>
  fetch('https://api.github.com/repos/NJUIS-Students/NJUIS-Students.github.io')
    .then(function (res) { if (!res.ok) throw new Error('GitHub request failed'); return res.json(); })
    .then(function (data) {
      var countEl = document.getElementById('wiki-stars-count');
      var badgeEl = document.getElementById('wiki-stars');
      if (countEl && badgeEl && data.stargazers_count !== undefined) {
...
<div class="project-facts" aria-label="智科全家桶共建情况">
<span><strong>30+</strong><small>位贡献者</small></span>
<span><strong>7</strong><small>个内容板块</small></span>
<span><strong>4 届学生</strong><small>接力撰写</small></span>
</div>
</div>
</div>
<div class="highlight-grid">
<article><strong>为什么开始</strong><span>许多重要经验只存在于一届人的记忆里，后来者却常常需要从头摸索。</span></article>
<article><strong>我在其中</strong><span>作为发起人，我搭起协作框架、推动内容建设，也持续连接愿意分享经验的同学。</span></article>
<article><strong>继续生长</strong><span>它不是由一个人写完的攻略，而是一份由一届届智科人共同补充的公共记忆。</span></article>
</div>
<div class="actions">
...
<div class="project-copy">
<p class="project-slogan">一款能看、会说、懂你的 AI 健康助手</p>
<p class="project-desc">知微见疾面向基层健康管理，把多 OCR 报告识别、异常分级与生活化解读，变成普通人能理解的健康报告；再通过西医、中医与中西医结合的连续问诊，衔接更贴近个人的健康建议与就医方向。</p>
<section class="project-awards" aria-labelledby="zhiwei-honours-title">
<div class="project-awards__label">
<span id="zhiwei-honours-title">HONOURS</span>
</div>
<ol class="project-awards__list">
<li><strong>全国一等奖</strong><span>挑战杯“人工智能+”创意赛</span></li>
<li><strong>全国一等奖</strong><span>“云智算杯”AI+应用创新大赛</span></li>
<li><strong>AI 先锋冠军</strong><span>南京大学“天池杯”AI创新大赛</span></li>
</ol>
</section>
</div>
</div>
<div class="highlight-grid">
<article><strong>真实问题</strong><span>面对血常规、尿常规与生化报告，用户缺少的不只是异常提示，更是听得懂的解释、风险轻重与可执行的下一步。</span></article>
...
<section>
<div class="block-head">
<h2 class="block-title">Course Work</h2>
<span class="block-mark">Early Builds</span>
</div>
<p class="course-intro">一些在课程里完成的小游戏，也是我最早把代码变成可见作品的记录。</p>
...
<p class="course-desc">用 C++ 与 Qt 复刻核心玩法，并为熟悉的游戏换上一套更轻盈的像素外衣。</p>
<div class="actions">
...
<p class="course-desc">使用 C 与 SDL 完成主要交互逻辑，再把一次课程作业变成森林里的小冒险。</p>
<div class="actions">
...
<p class="course-desc">使用 C++ 与 Qt 搭出采矿、加工与运输，让一条自动化生产线真正运转起来。</p>
<div class="actions">
